...
function spanish() {
    ...
    if (l == "") {
        document.querySelector("body > div.pageContainer > div.contentWrap > div.wrap > div > input").placeholder = "¿Que quieres saber?";
    } else if (l == "about") {
...
function english() {
    ...
    if (l == "") {
        document.querySelector("body > div.pageContainer > div.contentWrap > div.wrap > div > input").placeholder = "What would you like to know?";
    } else if (l == "about") {
